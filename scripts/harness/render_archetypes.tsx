...
import { AnswerCardStories, RankedBarsStories, CompareTableStories, CardPagerStories, TiersTableStories, RangeStripStories, pickAnswerCardInstances, pickRankedBarsInstances, pickCompareTableInstances, pickCardPagerInstances, pickTiersTableInstances, pickRangeStripInstances } from "../../src/components/spine/archetypes/stories";
...
const instances = { "answer-card": pickAnswerCardInstances(), "ranked-bars": pickRankedBarsInstances(), "compare-table": pickCompareTableInstances(), "card-pager": pickCardPagerInstances(), "tiers-table": pickTiersTableInstances(), "range-strip": pickRangeStripInstances() };
