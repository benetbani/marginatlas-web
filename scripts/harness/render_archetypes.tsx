...
import { AnswerCardStories, RankedBarsStories, CompareTableStories, CardPagerStories, TiersTableStories, pickAnswerCardInstances, pickRankedBarsInstances, pickCompareTableInstances, pickCardPagerInstances, pickTiersTableInstances } from "../../src/components/spine/archetypes/stories";
...
const instances = { "answer-card": pickAnswerCardInstances(), "ranked-bars": pickRankedBarsInstances(), "compare-table": pickCompareTableInstances(), "card-pager": pickCardPagerInstances(), "tiers-table": pickTiersTableInstances() };
