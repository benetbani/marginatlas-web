import io,sys
tw=io.open('scratchpad/tw-ri.css',encoding='utf-8').read()
card=io.open('scratchpad/ri-seed-%s.html'%sys.argv[1],encoding='utf-8').read()
io.open('scratchpad/ri-measure-%s.html'%sys.argv[1],'w',encoding='utf-8',newline='').write(
