...
If you're benchmarking a restaurant idea, the typical number tells you what to expect. The spread tells you what's achievable if you do everything right.

### Where the numbers come from

U.S. Census Bureau's Statistics of U.S. Businesses (SUSB), aggregated to the state level for NAICS code 7225 (Restaurants and Other Eating Places). 2021 data, the latest available.

More detail on every state at [marginatlas.com/us](/us).
