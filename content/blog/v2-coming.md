...
Margin Atlas v1.15 is the foundation. v2 plans include:

**Will be added:**

- 25-30 working country pipelines (we have 9-10 now)
- NUTS-2 regional granularity for EU member states
- Real distribution percentiles for every non-US cell via shape transfer
- Live API access for paid users
