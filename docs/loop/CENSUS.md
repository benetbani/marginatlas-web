...
| money | Money / LondonMarginBars / SpineCountryBody | Profit margin by trade | RankedBars or DetailPanel or BlockedSeat |  |
...
| running-costs | RunningCostsRanged / RunningCosts | Running costs | SegmentBar |  |
| insurance | InsuranceBars | Insurance | kit |  |
| financing | FinancingRanged | Borrowing | KvGrid |  |
| banking | BankingRing | Getting paid | KvGrid |  |
...
| exit | ExitCard | Time to sell | RangeStrip |  |
