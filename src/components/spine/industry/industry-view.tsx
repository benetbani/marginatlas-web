...
export const LOUD_SEATS = [
  ...
  { seat: 3, card: "08 channels", figure: "the largest revenue line's share", state: "HELD EMPTY", condition: "8.7's table says LIT and is stale: the donut landed on 2026-09-20 (Donut.tsx, his B9) with the leader's share in INK at its centre and the wedge the accent's colour on a drawing, which the accent budget does not count; accent three stays UNLIT by the trade spine's own sentence (a terracotta figure one band under the payback would out-rank it), so the page carries two" },
