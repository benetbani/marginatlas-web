...
export function SpineShell({ children, bg = DEFAULT_BG, bgPosition = "center 16%" }: { children: React.ReactNode; bg?: string; bgPosition?: string }) {
  return (
    <div className={`spine-scope ${geist.variable} ${grotesk.variable}`} style={{ fontFamily: "var(--font-geist), ui-sans-serif, system-ui, sans-serif" }}>
      ...
      <style>{`:root{--c-card:#ffffff;--c-soft:#f6f4f2;--c-soft2:#efebe8;--c-border:#e7e2df;--c-line-strong:#d8d0cb;--c-ink:#1b1b1a;--c-ink2:#565654;--c-muted:#6f6f6d;--terra:#fb8469;--terra-text:#c2410c;--terra-soft:#fff1ed;--terra-border:#ffc7ba;--t-micro:11px;--t-body:13px;--t-lead:16px;--t-sub:21px;}
