...
const fieldCls =
  "mt-1.5 w-full rounded-lg border border-parchment bg-cream-50 px-3 py-2.5 text-sm text-ink-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-atlas-500/40 focus-visible:ring-offset-2 focus-visible:ring-offset-cream-100";
const labelCls =
    ...
    <div className="atlas-card p-5 md:p-6">
      <form onSubmit={run} className="space-y-4">
        ...
        <button
          ...
          className="rounded-lg bg-atlas-500 px-5 py-2.5 text-sm font-medium text-cream-50 transition-colors hover:bg-atlas-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-atlas-500/40 focus-visible:ring-offset-2 focus-visible:ring-offset-cream-100 disabled:opacity-50"
        >
