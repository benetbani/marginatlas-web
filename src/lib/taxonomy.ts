...
export const INDUSTRY_SLUG_ALIASES: Record<string, string> = {
  /* AN ALIAS NAMES THE MOST EXACT LIVE TRADE (the goal's A7, 2026-09-24).
     Twenty-six words pointed at a parent written before the trade had its
     own entry: /gb/london/hostel printed Hotels & lodging while Hostels is a
     live trade, "jewelry" printed Clothing stores, "photographer" Marketing
     & design agencies. Each now points at the trade the word names; a
     videographer lands where videography was merged, on photography studios.
     scripts/verify_trade_resolution.ts reds an alias that a live trade's own
     keyword or example gives to a trade the alias does not reach. */
  ...
  "ice-cream": "ice_cream_shops",
  "juice-bar": "cafes_coffee",
  "tea-house": "tea_houses",
  "bnb": "hotels_lodging",
  "hostel": "hostels",
  "guesthouse": "guest_houses",
  "bed-and-breakfast": "hotels_lodging",
  "tour-operator": "travel_agencies",
  "travel-agency": "travel_agencies",
  ...
  "tutor": "tutoring_centers",
  "tutoring": "tutoring_centers",
  "language-school": "language_schools",
  "music-school": "music_schools",
