...
const BY_ID: Record<string, AtlasIconId> = {
  ...
  /* Ten trades drew the fallback shopfront or the salon's scissors until
     2026-09-25; each has its own glyph now (atlas-icons-data.ts). */
  barbershops: "trade-barber",
  nail_salons: "trade-nails",
  hotels_lodging: "trade-hotel",
  veterinary_pet_care: "trade-vet",
  accounting_tax: "trade-accounting",
  marketing_design: "trade-agency",
  bakeries_retail: "trade-bakery",
  cleaning_services: "trade-cleaning",
  dry_cleaning_laundry: "trade-laundry",
  food_trucks: "trade-food-truck",
